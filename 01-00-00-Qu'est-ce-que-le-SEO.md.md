...
graph LR
    A[Mot-clé principal] --> B[Intentions de recherche]
    B --> C1[Informationnelle]
    B --> C2[Transactionnelle]
    B --> C3[Navigationnelle]
    A --> D[Champ lexical]
    A --> E[Questions utilisateurs]
    A --> F[Maillage interne]
    D --> G[Synonymes]
    D --> H[Co-occurrences]
```
